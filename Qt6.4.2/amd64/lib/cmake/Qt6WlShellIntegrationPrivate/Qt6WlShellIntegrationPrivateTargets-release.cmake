...
set_target_properties(Qt6::WlShellIntegrationPrivate PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libQt6WlShellIntegration.so.6.4.2"
  IMPORTED_SONAME_RELEASE "libQt6WlShellIntegration.so.6"
  )

list(APPEND _IMPORT_CHECK_TARGETS Qt6::WlShellIntegrationPrivate )
list(APPEND _IMPORT_CHECK_FILES_FOR_Qt6::WlShellIntegrationPrivate "${_IMPORT_PREFIX}/lib/libQt6WlShellIntegration.so.6.4.2" )
